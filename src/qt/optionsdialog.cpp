    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new dmomintUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->dmomintAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting dmomint."), QMessageBox::Ok);
