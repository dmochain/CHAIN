...
#ifndef DMOMINT_UINT256_H
#define DMOMINT_UINT256_H
...
inline int Testuint256AdHoc(std::vector<std::string> vArg)
{
    ...
    uint256 e = uint256("0xDMODEF123DMOdef12345678909832180000011111111");
    printf("\n");
    printf("%s\n", e.ToString().c_str());


    printf("\n");
    uint256 x1 = uint256("0xDMODEF123DMOdef12345678909832180000011111111");
    uint256 x2;
    printf("%s\n", x1.ToString().c_str());
