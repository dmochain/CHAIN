...
const string strMessageMagic = "Dmomint Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uDMO
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
		...
		txNew.vout[8].scriptPubKey.SetDestination(CKeyID("ebe47a2e627e8c015534830474268becf1ea37da47c8a426b2336ed72dmo3257"));
