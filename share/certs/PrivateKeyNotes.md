...
unlocked to sign the dmomint-Qt.app bundle.
...
allowing somebody to distribute a dmomint-Qt.app or dmomint-qt-setup.exe with a valid
...
that the dmomint-qt.exe file inside the installer had not been tampered with.
