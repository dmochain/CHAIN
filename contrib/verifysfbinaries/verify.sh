...
WORKINGDIR="/tmp/dmomint"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/dmomint/Dmomint/dmomint-0.8.6/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/dmomint/Dmomint/"
VERSIONPREFIX="dmomint-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'dmomint-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[dmomint-]<version>-[rc[0-9]] (example: dmomint-0.7.1-rc1)"
   echo "wget output:"
