...
#ifndef H_dmoMINT_SCRIPT
#define H_dmoMINT_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CdmomintAddress
 */
...
public:
    ...
    // Pre-version-0.6, dmomint always counted CHECKMULTISIGs
