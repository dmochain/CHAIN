...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "dmomint " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dmomint-bohr.com", "dmomint-bohr.com"},
    {"dmomint-einstein.com", "dmomint-einstein.com"},
    {"dmomint-euclid.com","dmomint-euclid.com"},
    {"dmomint-feynman.com", "dmomint-feynman.com"},
    {"dmomint-gauss.com", "dmomint-gauss.com"},
    {"dmomint-newton.com", "dmomint-newton.com"},
    {"dmomint-planck.com", "dmomint-planck.com"},
    {"dmomint-turing.com", "dmomint-turing.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. dmomint is probably already running."), addrBind.ToString().c_str());
        else
